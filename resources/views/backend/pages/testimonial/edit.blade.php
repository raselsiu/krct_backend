        ...
        <div class="card-body">
            <form action="{{ route('updateTestimonial',$data->id) }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" rows="12" name="desc" class="form-control" placeholder="Write descriptions">{{ $data->desc }}</textarea>
                    @if ($errors->has('desc'))
                ...
                <div class="mb-4">
                    ...
                    <input type="text" rows="12" name="subtitle" class="form-control" value="{{ $data->subtitle }}" placeholder="Subtitle">
