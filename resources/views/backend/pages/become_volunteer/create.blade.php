...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('storeBecomeVolunteer') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label for="desc" class="form-label">Description</label>
                    <textarea type="text" name="desc" rows="12" class="form-control" placeholder="Write Short Descriptions"></textarea>
                    @if ($errors->has('desc'))
