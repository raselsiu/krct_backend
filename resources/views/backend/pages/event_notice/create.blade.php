...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('storeEventNotice') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label for="event_title" class="form-label">Event Title</label>
                    <input type="text" name="event_title" class="form-control" placeholder="Notice Title">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="event_time" class="form-control" placeholder="Ex 3:00 PM">
