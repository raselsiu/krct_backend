...
@section('content')
    <div class="card">
        ...
        <a href="{{ route('editService',$data->id) }}" class="btn btn-sm btn-primary" style="width: 60px;margin-left: 25px;border-radius: 5px;">Edit</a>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="image-gallery">
                        @foreach($images as $img)
                            <div class="image-item" style="margin: 10px; display:inline-block;">
                                <img src="{{ asset('images/services/'. $img) }}" alt="Image" width="150" style="border: 1px solid #ccc; padding: 5px;">
                            </div>
                        @endforeach
                    </div>
